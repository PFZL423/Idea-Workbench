...
STAGE_PROFILES: dict[str, dict[str, Any]] = {
    ...
    "research_opportunity_miner": {
        "focus": "bottleneck-shaped opportunities, failure modes, benchmark gaps, mechanism-transfer openings",
        "types": {"failure_signal", "benchmark_signal", "method_inspiration", "adjacent_transfer", "overlap_risk"},
        "keywords": [
            "bottleneck",
            "failure",
            "limitation",
    ...
    "research_builder": {
        "focus": "central insight, non-trivial mechanism match, novelty boundary, discriminating experiments",
        "types": {"method_inspiration", "adjacent_transfer", "benchmark_signal", "overlap_risk"},
        "keywords": [
            "mechanism",
            "novelty",
            "baseline",
    ...
    "research_critic_panel": {
        "focus": "comprehensive critique, prior-work boundary, feasibility, stronger baseline, contribution substance",
        "types": {"overlap_risk", "reviewer_attack", "failure_signal", "benchmark_signal", "abstract"},
        "keywords": [
            "prior",
            "overlap",
    ...
    "research_reviser": {
        "focus": "repairable potential, pivot paths, stronger mechanism, narrowed claim, discriminating experiment",
        "types": {"method_inspiration", "adjacent_transfer", "failure_signal", "benchmark_signal", "overlap_risk"},
        "keywords": [
            "repair",
            "pivot",
            "mechanism",
    ...
    "research_chair": {
        "focus": "final decision, next checks, global risks, closest prior-work attacks",
        "types": {"overlap_risk", "reviewer_attack", "failure_signal", "benchmark_signal", "abstract"},
        "keywords": [
            "decision",
            "risk",
